...
class SolverWrapper(object):
    ...
    def snapshot(self, sess, iter):
        ...
        print ('Wrote snapshot to: {}'.format(filename))
    ...
    def train_model(self, sess, max_iters):
        ...
        for iter in range(max_iters):
            ...
            if (iter+1) % (cfg.TRAIN.DISPLAY) == 0:
                print ('''
                      iter: {} / {}, total loss: {:.4f}, rpn_loss_cls: {:.4f}, rpn_loss_box: 
                      {:.4f}, loss_cls: {:.4f}, loss_box: {:.4f}, lr: {}'''.format(
                      iter+1, max_iters, rpn_loss_cls_value + rpn_loss_box_value + loss_cls_value + 
                      loss_box_value ,rpn_loss_cls_value, rpn_loss_box_value,loss_cls_value, 
                      loss_box_value, lr.eval() ) )

                print("speed: {}s / iter".format(timer.average_time))
